...
func (_m *Ride) FindAll(_a0 context.Context, _a1 ...repo.SelectCriteria) ([]entity.Ride, error) {
	...
	var r0 []entity.Ride
	if rf, ok := ret.Get(0).(func(context.Context, ...repo.SelectCriteria) []entity.Ride); ok {
		r0 = rf(_a0, _a1...)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Ride) FindOne(_a0 context.Context, _a1 ...repo.SelectCriteria) (entity.Ride, error) {
	_va := make([]interface{}, len(_a1))
	for _i := range _a1 {
		_va[_i] = _a1[_i]
	}
